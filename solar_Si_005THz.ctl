...
(define-param out_dir "solar_test_Si_f005THz")		
...
(set! geometry-lattice (make lattice (size 0.05774 0.05774 200))) ;a=100um 
(set! geometry (list 
...
(set! pml-layers (list (make absorber (direction Z) (thickness 60 ))))


(set! sources (list
	(make source 
		(size 0 0 1)  
		(src (make gaussian-src (frequency 0.017) (fwidth 1) )) ;f=0.05THz
		(component Ex)
                ;(component Hy) 
		(amplitude 1)
		(center 0 0 35)
